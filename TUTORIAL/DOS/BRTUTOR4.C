...
/*Load and Position Planet Actor*/
	...
	BrMatrix34Translate(&planet->t.t.mat,BR_SCALAR(14.0),BR_SCALAR(14.0),BR_SCALAR(-40.0));     
...
/*Load and Position Satellite */
	...
	BrMatrix34Scale(&sat->t.t.mat,BR_SCALAR(0.5),BR_SCALAR(0.5),BR_SCALAR(0.5));
	BrMatrix34PostTranslate(&sat->t.t.mat,BR_SCALAR(2.0),BR_SCALAR(0.0),BR_SCALAR(0.0));
...
/******************************* Animation Loop ****************************/
	...
	for(i=0;i<500;i++) {
		...
		BrMatrix34PostTranslate(&planet->t.t.mat,BR_SCALAR(-0.033),BR_SCALAR(-0.032),BR_SCALAR(0.1));
